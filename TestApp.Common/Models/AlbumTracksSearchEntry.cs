...
namespace TestApp.Common.Models
{
    ...
    public class AlbumTracksSearchEntry
    {
        [JsonProperty("wrapperType", Required = Required.DisallowNull, NullValueHandling = NullValueHandling.Ignore)]
        public string WrapperType { get; set; }

        [JsonProperty("collectionType", Required = Required.DisallowNull, NullValueHandling = NullValueHandling.Ignore)]
        ...
        [JsonProperty("amgArtistId", Required = Required.DisallowNull, NullValueHandling = NullValueHandling.Ignore)]
        ...
        [JsonProperty("copyright", Required = Required.DisallowNull, NullValueHandling = NullValueHandling.Ignore)]
